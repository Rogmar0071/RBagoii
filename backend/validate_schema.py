...
def validate_schema() -> None:
    ...
    try:
        ...
        if failed_validations:
            ...
            print("\nDatabase schema is not aligned with application expectations.", file=sys.stderr)
            print("Run 'alembic upgrade head' to apply missing migrations.", file=sys.stderr)
            sys.exit(1)
