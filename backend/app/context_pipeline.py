...
def _stage_activate(final_context: FinalContext) -> ActiveContextSession:
    """
    Stage 8 — Activation.

    RULE: ONLY runs if AlignedIntentContract.valid is True.
          FAIL HARD otherwise.
...
def run_context_pipeline(
    ...
    *,
    ...
    # Stage 8 — Activation
    active_session = _stage_activate(final_context)
