...
def test_phase_6_rapid_toggle():
    ...
    try:
        ...
        output_1, _ = mode_engine_gateway(
            user_intent=message, modes=[], ai_call=ai_call_1, base_system_prompt=""
        )
        ...
        output_2, _ = mode_engine_gateway(
            user_intent=message, modes=[MODE_STRICT], ai_call=ai_call_2, base_system_prompt=""
        )
        ...
        output_3, _ = mode_engine_gateway(
            user_intent=message, modes=[], ai_call=ai_call_3, base_system_prompt=""
        )
        ...
        output_4, _ = mode_engine_gateway(
            user_intent=message, modes=[MODE_STRICT], ai_call=ai_call_4, base_system_prompt=""
        )
...
def test_phase_7_hard_invariants():
    ...
    try:
        ...
        output, audit = mode_engine_gateway(
            user_intent="test", modes=[], ai_call=ai_call, base_system_prompt=""
        )
        assert len(audit.validation_results) == 0
        ...
        ai_call = MagicMock(return_value="test")
        output, audit = mode_engine_gateway(
            user_intent="test", modes=[MODE_STRICT], ai_call=ai_call, base_system_prompt=""
        )
        assert len(audit.validation_results) > 0
    ...
    try:
        ...
        _, audit_1 = mode_engine_gateway(
            user_intent="query 1", modes=[MODE_STRICT], ai_call=ai_call_1, base_system_prompt=""
        )

        ai_call_2 = MagicMock(return_value="response 2")
        _, audit_2 = mode_engine_gateway(
            user_intent="query 2", modes=[], ai_call=ai_call_2, base_system_prompt=""
        )

        ai_call_3 = MagicMock(return_value="response 3")
        _, audit_3 = mode_engine_gateway(
            user_intent="query 3", modes=[MODE_STRICT], ai_call=ai_call_3, base_system_prompt=""
        )
    ...
    try:
        ...
        output_normal, _ = mode_engine_gateway(
            user_intent=message, modes=[], ai_call=ai_call_normal, base_system_prompt=""
        )

        ai_call_strict = MagicMock(return_value=ai_response)
        output_strict, _ = mode_engine_gateway(
            user_intent=message, modes=[MODE_STRICT], ai_call=ai_call_strict, base_system_prompt=""
        )
    ...
    try:
        ...
        output_1, _ = mode_engine_gateway(
            user_intent="test", modes=[], ai_call=ai_call_1, base_system_prompt=""
        )

        ai_call_2 = MagicMock(return_value="response")
        output_2, _ = mode_engine_gateway(
            user_intent="test", modes=[], ai_call=ai_call_2, base_system_prompt=""
        )
        ...
        output_3, _ = mode_engine_gateway(
            user_intent="test", modes=[MODE_STRICT], ai_call=ai_call_3, base_system_prompt=""
        )

        ai_call_4 = MagicMock(return_value="response")
        output_4, _ = mode_engine_gateway(
            user_intent="test", modes=[MODE_STRICT], ai_call=ai_call_4, base_system_prompt=""
        )
